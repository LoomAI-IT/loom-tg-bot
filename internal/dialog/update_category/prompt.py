...
Когда появляются новые эталонные примеры, хорошие паттерны или антипаттерны, то пересматривай их список, и оставляй только акутальные исходя из фидбэка пользователя
</logic>
