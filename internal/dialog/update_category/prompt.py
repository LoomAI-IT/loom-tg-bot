...
1. КОНФЛИКТЫ в параметрах:
   - Если есть противоречия: good с good, или bad с bad, или good с bad, или любые другие парметры между собой → зафиксируй конфликт
...
<blockquote>
[Перечисли группы похожих паттернов]
</blockquote>
