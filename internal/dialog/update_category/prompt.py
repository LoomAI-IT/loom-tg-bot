...
ЕСЛИ пользователь пришел со Stage 1 И на Stage 1 были выявлены конфликты/дубли:
  ...
  → Применить изменения к параметрам
...
4. Переход к обычному substage 3.1
</processing>
...
<p>Теперь можем продолжить <b>дообучение на реальных примерах</b> 🚀</p>
<p>Продолжаем?</p>
</message_template>
...
<transition>
→ Автоматический переход к substage 3.1 (начало дообучения)
</transition>
