...
<span><b>🔄 Сравнение с текущей рубрикой</b></span><b>💡 Ключевые рекомендации:</b><span><b>🔄 Сравнение с текущей рубрикой</b></span>
<details>
<ol>
...
<message_template>
<span><b>📊 Образец {{current_iteration}} из ~5-7 рекомендуемых</b></span>
...
<span><i>💡 Уже собрано {{current_iteration}} образцов — этого достаточно для качественной генерации! Можешь завершить или продолжить.</i></span>
</message_template>
...
<span>ℹ️ Достигнут лимит эталонов (10 шт). Заменил самый старый и непохожий образец на новый.</span>
</details>

<!-- Может быть блок с умной очисткой если конфликты -->

<span><b>Создать еще образец?</b></span>
...
<span>Проведено тестов: <b>{{test_counter}}</b></span>
<ol>
