...
class ErrorFlagsManager:
    ...
    @staticmethod
    def clear_image_prompt(dialog_manager: DialogManager) -> None:
        ErrorFlagsManager.clear(
            dialog_manager,
    ...
    @staticmethod
    def clear_text_edit(dialog_manager: DialogManager) -> None:
        ErrorFlagsManager.clear(
            dialog_manager,
            "has_void_text",
            "has_big_text",
    ...
    @staticmethod
    def clear_image_upload(dialog_manager: DialogManager) -> None:
        ErrorFlagsManager.clear(
            dialog_manager,
    ...
    @staticmethod
    def clear_combine_prompt(dialog_manager: DialogManager) -> None:
        ErrorFlagsManager.clear(
            dialog_manager,
    ...
    @staticmethod
    def clear_combine_upload(dialog_manager: DialogManager) -> None:
        ErrorFlagsManager.clear(
            dialog_manager,
    ...
    @staticmethod
    def clear_new_image_confirm(dialog_manager: DialogManager) -> None:
        ErrorFlagsManager.clear(
            dialog_manager,
