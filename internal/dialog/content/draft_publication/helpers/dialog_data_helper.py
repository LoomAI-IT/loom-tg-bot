...
class DialogDataHelper:
    ...
    @staticmethod
    def get_draft_list(dialog_manager: DialogManager) -> list:
        return dialog_manager.dialog_data.get("draft_list", [])
    ...
    @staticmethod
    def set_draft_list(dialog_manager: DialogManager, moderation_list: list) -> None:
        dialog_manager.dialog_data["draft_list"] = moderation_list
