...
class DraftPublicationGetter(interface.IDraftPublicationGetter):
    def __init__(
            self,
    ...
    async def get_draft_list_data(
        ...
        self.dialog_data_helper.set_draft_list(dialog_manager, draft_publications)
        ...
        current_pub = model.Publication(**draft_publications[current_index])
        ...
        preview_image_media, image_url = self.image_manager.get_draft_image_media(
        ...
        data = {
            ...
            "total_count": len(draft_publications),
            "has_prev": current_index > 0,
            "has_next": current_index < len(draft_publications) - 1,
        }
