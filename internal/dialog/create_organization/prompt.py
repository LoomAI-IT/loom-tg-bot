...
<span><b>🎯 Что будет дальше?</b></span>
<details>
<span>После получения информации <b>автоматически сгенерирует</b>:</span>
<ol>
...
<span>• Ссылки на чужие компании "для вдохновения"</span>
<span>• Подробное описание всех продуктов</span>
<span>• Полную информацию о компании</span>
