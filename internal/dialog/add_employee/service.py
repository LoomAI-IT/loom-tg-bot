...
class AddEmployeeService(interface.IAddEmployeeService):
    ...
    async def handle_account_id_input(
        ...
        with self.tracer.start_as_current_span(
                "AddEmployeeService.handle_account_id_input",
    ...
    async def handle_name_input(
        ...
        with self.tracer.start_as_current_span(
                "AddEmployeeService.handle_name_input",
                kind=SpanKind.INTERNAL
        ) as span:
            try:
    ...
    async def handle_role_selection(
        ...
        with self.tracer.start_as_current_span(
                "AddEmployeeService.handle_role_selection",
                kind=SpanKind.INTERNAL
        ) as span:
            try:
    ...
    async def handle_toggle_permission(
        ...
        with self.tracer.start_as_current_span(
                "AddEmployeeService.handle_toggle_permission",
                kind=SpanKind.INTERNAL
        ) as span:
            try:
    ...
    async def handle_create_employee(
        ...
        with self.tracer.start_as_current_span(
                "AddEmployeeService.handle_create_employee",
                kind=SpanKind.INTERNAL
        ) as span:
            try:
    ...
    async def handle_go_to_organization_menu(
        ...
        with self.tracer.start_as_current_span(
                "AddEmployeeService.handle_go_to_organization_menu",
                kind=SpanKind.INTERNAL
        ) as span:
            try:
