...
<details>
[ЕСЛИ ЕСТЬ КОНФЛИКТЫ]
<span><b>Конфликты между правилами:</b></span>
...
{{
    ...
    // ВСЕГДА, когда ты использовать поиск в интернете записывай сюда подробнейший результат анализа
