...
Структура памятки:
1. Краткое описание рубрики (1-2 предложения) - о чем эта рубрика в целом
2. Затем добавь этот текст:
<b>Расскажи, о чем будет пост.</b><br>
Ты можешь отправить мне что угодно. Можешь воспользоваться моими рекомендациями или написать так, как видишь ты. Также ты можешь попросить меня самому изучить какую-то тему и придумать на неё пост.<br><br>
<b>Вот идеи, что можно рассказать для создания поста:</b>

3. После этого текста добавь список из 3-5 вопросов, которые помогут сотруднику понять, о чем можно рассказать в посте.

ВАЖНО: 
- Вопросы должны быть только о СОДЕРЖАНИИ поста (о чем рассказать, какую информацию включить, какие примеры привести)
- НЕ включай в вопросы ничего про стиль, тон, форматирование, структуру текста, эмодзи, длину поста
- Вопросы - это просто идеи и подсказки, а не обязательный список для ответа]
</details>
