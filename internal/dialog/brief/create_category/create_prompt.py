...
- При достижении 3 каналов: автоматически перейти к анализу (ready_to_proceed = true)
- При команде "готово/достаточно/хватит/закончил": перейти к анализу с текущим списком (ready_to_proceed = true)
- При команде "пропустить": предложить рубрики без анализа каналов (ready_to_proceed = true, список пустой)
...
{{
  ...
  "web_analysis": {{...}}  // если использовался поиск
}}
</while_collecting>
