...
[5 рубрик с названием и описанием: для чего подходит, какие темы охватывает через JTBD подход (с использованием <ol>)]
</details>
...
<details>
<summary><b>Посмотреть правила бренда</b></summary>
