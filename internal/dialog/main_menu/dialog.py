            ...
            Case(
                {
                    False: Multi(
                        ...
                        Format("<br>👋 Привет, {name}! Я буду создавать контент для твоей компании вместе с тобой. <br>"),
                        Const("<br>Расскажи мне о чём-нибудь текстом или голосом — и начнём ✨ <br>"),
                        Const("<br>Готов? Жду твоё сообщение! Или воспользуйся кнопками ниже👇 <br>"),
