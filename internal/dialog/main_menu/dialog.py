            ...
            Case(
                {
                    False: Multi(
                        ...
                        Format("{name}, превращаем идеи в готовый контент! 🚀<br><br>"),
                        Const("<b>Просто отправь:</b><br>"),
                        Const("• Идею текстом<br>"),
                        Const("• Голосовое сообщение<br>"),
                        Const("• Ссылку на YouTube<br><br>"),
                        Const("Я создам публикацию с текстом и картинкой.<br><br>"),
                        Const("👇 <b>Или выбери действие:</b><br>"),
                        Const("📝 <b>Контент</b> — генерация, черновики, модерация<br>"),
                        Const("🏢 <b>Организация</b> — настройки, команда, баланс<br>"),
                        Const("👨‍💼 <b>Личный кабинет</b> — твои данные<br>"),
