                ...
                Case(
                    {
                        False: Multi(
                            ...
                            Const("<code>Пример: Сделай короче</code><br><br>"),
                ...
                Case(
                    {
                        True: Multi(
                            ...
                            Const("<code>Пример: Сделай фон светлее</code><br><br>"),
                        ...
                        False: Multi(
                            ...
                            Const("<code>Пример: Офисное пространство в стиле минимализм</code><br><br>"),
                            Const("📝 <b>Что можно указать в описании:</b><br>"),
