...
<b>Примеры рубрик для вашей организации</b>
<details>
...
<context>
<b>Как сформулировать цель через JTBD?</b>
<details>
...
<context>
<b>Целевая аудитория твоей компании</b>
<details>
[Покажи целевую аудиторию из organization_data в читаемом формате]
</details>

<b>Моё предложение сегмента для этой рубрики</b>
<details>
...
<p><b>🎯 Последний этап: Дообучение на реальных примерах</b></p>

<p>Теперь самое важное — научить систему твоим предпочтениям!</p>
...
<p><b>Цель:</b> Создать 2 эталонных поста, чтобы система точно поняла твой стиль 💪</p>
...
<p><b>О чём создать первый пост?</b> Напиши тему или текст.</p>

[ЕСЛИ это не первая итерация:]
<p><b>Прогресс:</b> {{full_examples_count}}/2 эталонных постов ✅</p>
...
<p>О чём создать следующий пост? 🎯</p>
</message_template>
...
<b>💡 Мои предложения</b>
<details>
<p>[2-3 конкретных совета как сделать пост лучше]</p>
</details>
...
<p><i>Или опиши что именно тебе нравится/не нравится в посте</i></p>
</message_template>
...
<p><b>✅ Отлично! Записала эталон!</b></p>

<p><b>Что я запомнила:</b></p>
<blockquote>
<b>Эталонный пост:</b> Полный текст сохранён
<b>Извлечённые приёмы:</b>
<ul>
...
<p>Давай создадим ещё один образец! О чём следующий пост? 🎯</p>

[ЕСЛИ full_examples_count >= 2:]
<p><b>🎉 Ура! Собрано 2 эталонных поста!</b></p>

<p><b>Система запомнила:</b></p>
<blockquote>
<b>Эталонов:</b> {{full_examples_count}}
<b>Паттернов успеха:</b> {{количество паттернов}}
<b>Правил что избегать:</b> {{количество антипаттернов}}
</blockquote>

<p>Теперь система понимает твой стиль! Переходим к финальным настройкам? 🚀</p>
</message_template>
...
<message_template>
<p><b>✅ Записала замечания!</b></p>

<p><b>Что я запомнила избегать:</b></p>
<blockquote>
[ДЛЯ КАЖДОГО АНТИПАТТЕРНА:]
<p><b>❌ {{what_wrong}}</b></p>
<p><i>Проблема:</i> {{why_wrong}}</p>
<p><i>Как исправить:</i> {{how_to_fix}}</p>
</blockquote>
...
<message_template>
<p><b>✅ Отлично, записала!</b></p>

<b>✅ Что понравилось - запомнила как хорошие приёмы</b>
<details open>
[СПИСОК ПАТТЕРНОВ]
</details>

<b>⚠️ Что не понравилось - буду избегать</b>
<details open>
