...
<!-- ─────────────────────────────────────────────────────────────────────────────── -->
<substage id="2.2" name="Анализ референсов">
<!-- ─────────────────────────────────────────────────────────────────────────────── -->

<objective>Проанализировать все собранные референсы и извлечь паттерны</objective>
...
<json_output>
{{
  "message_to_user": null,  // Этот stage без сообщения
  "current_stage": "2.2",
  "prev_stage": "2.1.1",
  "next_stage": "2.3"
}}
...
<transition>
- condition: Анализ завершен
- next_stage: 2.3 (автоматически)
</transition>

</substage>

<!-- ─────────────────────────────────────────────────────────────────────────────── -->
<substage id="2.3" name="Предложение вариантов рубрик">
<!-- ─────────────────────────────────────────────────────────────────────────────── -->
...
{{
    ...
    "user_text_reference": str,  // Только в stage 4.2 - тема для генерации
    "test_category": {{...}},    // Только в stage 4.2 - для генерации поста
