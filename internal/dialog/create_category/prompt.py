...
<blockquote>
<b>📝 Стратегия сбора:</b>
1️⃣ <b>Начни с одного телеграм канала</b> — скинь канал, который тебе нравится
2️⃣ <b>Получи набросок</b> — я проанализирую и предложу первые идеи для рубрик
3️⃣ <b>Добавляй референсы</b> — постепенно загружай больше примеров
...
<li><b>Текстовые примеры</b> — примеры постов или описание стиля, можешь даже переслать их из других каналов</li>
</ol>

<blockquote>
<b>📊 Лимиты:</b>
├─ Telegram каналов: <b>до 3 шт</b>
├─ Ссылок: <b>до 5 шт</b>
└─ Текстовых примеров: <b>до 5 шт</b>
</blockquote>

<p><b>💡 Совет:</b> Лучше начать с телеграм канала, чтобы я сразу могла предложить первые наброски рубрик!</p>
...
<proposal>
[Предложи 3-5 вариантов названия для этой рубрики]
</proposal>
</parameter>
...
<parameter n="12" field="additional_info">
...
{{
  ...
  // Добавляй только когда пользователь соберет все параметры
  "working_category": {{
    "name": str,
...
{{
  ...
  "working_category": {{
    // обновленная рубрика с добавленными samples
    "good_samples": [...],
    "bad_samples": [...]
  }}
}}
