...
<message_template constraint="3700 символов, иначе будет ОШИБКА">
...
<json_output>
{{
  // ограничение на 3700 символов, если будет больше, то систем упдает с ошибкой
  "message_to_user": "[сообщение выше]", // ограничение на 3700 символов, если будет больше, то систем упдает с ошибкой
  "current_stage": "2.2",
  "prev_stage": "2.1.1",
  "next_stage": "3"
}}
