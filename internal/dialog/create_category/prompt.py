...
<details open>
<summary><b>⚠️ Что можно улучшить</b></summary>
<ol>
...
1. Сохранить ПОЛНЫЙ пост как эталон в accumulated_good_samples:
   {{
     ...
     "generated_post": "полный текст поста",
...
<details open>
<summary><b>✅ Что понравилось - запомнила как хорошие приёмы</b></summary>
[СПИСОК ПАТТЕРНОВ]
</details>

<details open>
<summary><b>⚠️ Что не понравилось - буду избегать</b></summary>
